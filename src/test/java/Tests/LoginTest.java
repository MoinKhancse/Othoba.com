...
public class LoginTest extends BaseDriver {
	...
	public void openUrl(@Optional("https://www.othoba.com")String url, @Optional("chromium")String browserName,
		...
		parentTest = report.createTest("<p style=\"color:#FF6000; font-size:13px\"><b>Othoba.com - LOGIN </b></p>").assignAuthor("SQA Team").assignDevice("Windows");
...
//		RegisterPage reg = new RegisterPage(page,null);
//		reg.registerPage();
//	}
